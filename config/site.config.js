...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'sakuramoe@obsessedurologist.onmicrosoft.com',
  ...
  email: 'mailto:admin@sakuramoe.dev',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/mxihan/',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/hoshimi_rin',
    },
  ],
